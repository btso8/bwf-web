...
function Account() {
  ...
  const uploadFile = async (e) => {
    ...
    if (uploaded) {
      ...
      NotificationManager.error("Error. Image was not uploaded");
    }
  };
    ...
    <div>
      ...
      <form onSubmit={submitChangePass}>
        <Grid container spacing={1} alignItems="flex-end">
          ...
          <Grid item>
            <TextField
              id="old-password-input-with-icon-grid"
              label="Old Password"
              type="password"
        ...
        <Grid container spacing={1} alignItems="flex-end">
          ...
          <Grid item>
            <TextField
              id="new-password-input-with-icon-grid"
              label="New Password"
              type="password"
        ...
        <Grid container spacing={1} alignItems="flex-end">
          ...
          <Grid item>
            <TextField
              id="check-new-password-input-with-icon-grid"
